...
describe('a GetRepliesEntity entity', () => {
  it('should throw error when payload did not contain needed property', () => {
    ...
    // Action and Assert
    expect(() => new GetRepliesEntity(payload))
      .toThrowError('GET_REPLIES_ENTITY.NOT_CONTAIN_NEEDED_PROPERTY');
  });
  ...
  it('should throw error when payload did not meet data type specification', () => {
    ...
    // Action and Assert
    expect(() => new GetRepliesEntity(payload))
      .toThrowError('GET_REPLIES_ENTITY.NOT_MEET_DATA_TYPE_SPECIFICATION');
  });
