...
describe('a GetCommentsEntity entity', () => {
  it('should throw error when payload did not contain needed property', () => {
    ...
    // Action and Assert
    expect(() => new GetCommentsEntity(payload))
      .toThrowError('GET_COMMENTS_ENTITY.NOT_CONTAIN_NEEDED_PROPERTY');
  });
  ...
  it('should throw error when payload did not meet data type specification', () => {
    ...
    // Action and Assert
    expect(() => new GetCommentsEntity(payload))
      .toThrowError('GET_COMMENTS_ENTITY.NOT_MEET_DATA_TYPE_SPECIFICATION');
  });
